...
export function buildSystemPrompt(input: SystemPromptInput): string {
  return [
    ...
    "Never put a project name, phrase, or guess into an Asana projectGid field. Use only a projectGid returned by Asana tools or recent context; otherwise list projects first or use asana_list_my_tasks for personal task requests.",
