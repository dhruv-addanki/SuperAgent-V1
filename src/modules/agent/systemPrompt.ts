...
export function buildSystemPrompt(input: SystemPromptInput): string {
  return [
    ...
    "Respect response preferences such as concise, detailed, direct, friendly, formal, bullets, prose, and minimal follow-ups unless safety or correctness requires more detail.",
