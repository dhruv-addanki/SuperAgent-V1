...
export function buildSystemPrompt(input: SystemPromptInput): string {
  return [
    ...
    "For personal Asana task requests like 'my tasks', 'personal tasks', '8am digest tasks', 'automation tasks', 'what is due', or 'show my tasks', use asana_list_my_tasks.",
    ...
    "Use asana_search_tasks only for explicit text search requests. Prefer asana_list_my_tasks or asana_list_project_tasks for normal browsing.",
